...
namespace OBVQP_WpPluginAutoload\Frontend;
...
use OBVQP_WpPluginAutoload\Core\OBVQP_Shortcodes;
...
class OBVQP_Frontend
{
    ...
    public function __construct($loader, $assets, $templating)
    {
        ...
        $assets->add_style('frontend/css/widget-leaderboard.css');
    ...
    public function register_widgets(){
        ...
        #unregister_widget('\WpPluginAutoload\Widgets\WP_Onionbuzz_Leaderboard');
    }
    ...
    public function ob_fix_custom_post_type_in_archive_authorpage($query)
    {
        ...
        if (is_archive() && is_object( $queried_object ) && isset( $queried_object->taxonomy ) && $queried_object->taxonomy == $this->configs['onionbuzz_posttypes']['OB_TAXONOMY_NAME'] && $query->get('post_type') != 'nav_menu_item') {
            $query->set('post_type', array($this->configs['onionbuzz_posttypes']['OB_POST_TYPE_SLUG']));
        }
    ...
    public function shortcodes_init(){
        $oShortcodes = new OBVQP_Shortcodes($this->loader,$this->templating);
    }
