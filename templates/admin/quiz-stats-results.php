<div class="laqm-admin">
    ...
    <div class="laqm-content floating-area">
        ...
        <div class="laqm-tab-content">
            ...
            <div class="laqm-item quiz-stat-players">
                <div class="laqm-item-info">
                    <div class="laqm-item-title-tools stats">
                        ...
                        <div class="laqm-item-title col-sm-6" data-id="1" data-quiz_id="8">
                            Result
                        </div>
            ...
            <?php foreach ($data['results_list'] as $k=>$v){?>
            <div class="laqm-item quiz-stat-players">
                <div class="laqm-item-info">
                    <div class="laqm-item-title-tools white">
                        ...
                        <div class="laqm-item-title col-sm-6" data-id="1" data-quiz_id="8">
                            <?=$data['results_list'][$k]['title']?>
                        </div>
                        <div class="laqm-item-title col-sm-3 ">
                            <?=round( $data['results_list'][$k]['avg_players'], 2, PHP_ROUND_HALF_UP)?>%
                        </div>
